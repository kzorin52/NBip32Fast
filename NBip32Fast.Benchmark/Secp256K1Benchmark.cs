...
public class Secp256K1Benchmark
{
    ...
    {
        return NBitcoin.ExtKey.CreateFromSeed(_seedBytes).Derive(NBitcoin.KeyPath.Parse(KeyPath)).PrivateKey.ToBytes();
    }
    ...
    public byte[] NBip32FastKey()
    {
        ...
        NBip32Fast.Secp256K1.Secp256K1HdKey.Instance.DerivePath(NBip32Fast.KeyPath.Parse(KeyPath).Elements, _seedBytes, ref der);
